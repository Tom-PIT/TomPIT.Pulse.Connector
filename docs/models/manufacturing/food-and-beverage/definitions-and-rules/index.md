...
Defines the shared measurements, limits, classifications, and operational rules used by Food & Beverage integrations.

Register these definitions before submitting production or operational records that reference them.
...
| [Types](type.md) | Defines controlled classifications and their allowed values for supported master-data fields. |

<!-- TODO:  missing material-limit.md, we'll add it when it's ready -->