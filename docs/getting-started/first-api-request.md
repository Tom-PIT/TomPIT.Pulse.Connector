...
Use the [Plant](../integration/master-data/plant.md) service for your first test request.
...
1. Synchronize the remaining required [master data](../integration/master-data/index.md).
2. Create a [Batch](../integration/manufacturing/batch.md).
3. Create the related [Stages](../integration/manufacturing/stage.md).
4. Submit plans, usage, output, downtime, waste, or [measurements](../integration/measurements.md).
