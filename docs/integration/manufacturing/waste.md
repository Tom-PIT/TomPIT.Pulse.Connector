...
A waste record identifies where and when the loss occurred. It may also classify the loss through a [waste type](../master-data/waste-type.md).
...
```json
{
  "id": 812,
  "stage": 208,
  "date": "2026-07-20T10:42:00+02:00",
  "type": 14
}
```
...
| `date` | string | Date and time when the waste occurred or was recorded, in ISO 8601 format. | `"2026-07-20T10:42:00+02:00"` |
| [`type`](../master-data/waste-type.md) | integer or null | Optional Pulse `id` of the waste type. | `14` |
